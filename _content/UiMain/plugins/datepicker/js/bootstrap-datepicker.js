      ...
      var localDate = this._utc_to_local(this.viewDate);
		...
		fill: function(){
			...
			while (prevMonth.valueOf() < nextMonth){
				...
				html.push('<td class="' + clsName.join(' ') + '"' + (tooltip ? ' title="' + tooltip + '"' : '') + '>' + (urlmy!=' ' ? '<a href="' + urlmy + '">' : '') + prevMonth.getUTCDate() + (urlmy!=' ' ? '</a>' : '') + '</td>');
				tooltip = null;
